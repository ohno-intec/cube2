...
@section('content')
	...
	<form action="{{ url('masters/products') }}" method="post">
		...
		<div class="form-group">
			<label>在庫保有</label>
			<label class="radio-inline"><input type="radio" name="product_stockholdingcode" value="1">有り</label>
			<label class="radio-inline"><input type="radio" name="product_stockholdingcode" value="2">無し</label>
		</div>
		<div class="form-group">
			<label>棚番コード</label>
			<select class="form-control" name="product_rackcode">
		...
		<div class="form-group">
			<label>倉庫保有</label>
			<label class="radio-inline"><input type="radio" name="product_warehouseholdingcode" value="1">有り</label>
			<label class="radio-inline"><input type="radio" name="product_warehouseholdingcode" value="2">無し</label>
		</div>
